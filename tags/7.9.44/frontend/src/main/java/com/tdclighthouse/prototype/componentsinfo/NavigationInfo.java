...
public interface NavigationInfo extends SimpleNavigationInfo, LabelsInfo {
    ...
    public static final String USE_INDEX_DOCUMENT = "useIndexDocument";
    public static final String USE_INDEX_DOCUMENT_DEFAULT = "true";
    ...
    @Parameter(name = USE_INDEX_DOCUMENT, defaultValue = USE_INDEX_DOCUMENT_DEFAULT, displayName = "Use index documents as representative of the folders.")
    public boolean isUseIndexDocument();
