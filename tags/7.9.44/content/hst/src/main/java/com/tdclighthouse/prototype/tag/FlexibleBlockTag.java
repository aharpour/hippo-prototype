...
public class FlexibleBlockTag extends PrototypeTagSupport {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(FlexibleBlockTag.class);
    private static final long serialVersionUID = 1L;

    private transient List<HippoBean> content;
        ...
        try {
            ...
            for (int i = 0; i < content.size(); i++) {
                ...
                if (hippoBean instanceof ParagraphBean) {
                    ParagraphBlockTag
                            .renderParagraph((ParagraphBean) hippoBean, out, getHstRequest(), getHstResponse());
                    ...
                    if (hippoBean != null) {
                        LOG.error("flexibleblock tag does not support items of type \""
                                + hippoBean.getClass().getName() + "\"");
                    }
                }
